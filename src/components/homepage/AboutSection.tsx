    ...
    <section id="sobre" className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-8 grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div className="relative">
          ...
          {data.subtitle && (
            <p className="mt-4 text-base text-gray-700" style={{ fontFamily: 'Inter' }}>{data.subtitle}</p>
          )}
          {descriptionTexts.map((text, i) => (
            <p key={i} className="mt-4 text-base text-gray-600" style={{ fontFamily: 'Inter' }}>{text}</p>
          ))}
          {data.ctaText && (
            <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 text-gray-600 text-sm" style={{ fontFamily: 'Inter' }}>
